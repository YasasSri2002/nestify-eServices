                        ...
                        <div className="grid ml-5">
                            <div className="flex md:justify-between w-full">
                                ...
                                Name:
                                 ...
                                 <h1 className="first-line:uppercase">{providers.userName.charAt(0).toUpperCase()+ providers.userName.slice(1)}
                                </h1>
                            </div>
                            <div className="flex md:justify-between w-full">
                                <h1 className="first-letter:uppercase">Experties:</h1>
                                <h1 className="capitalize">{providers.expertise}</h1>
                            </div>
                            <div className="flex md:justify-between w-full">
                                <h1 className="first-letter:uppercase">experience:</h1>
                                <h1>{providers.experience}</h1>
                            </div>

                        </div>
                        <div className="flex md:mt-5 sm:justify-end justify-normal items-end space-x-5">
