    ...
    return(
        ...
        <div className="flex flex-col md:flex-row bg-[#121212e1] text-[hsla(0,0%,90%,1)] mt-5">
            <div className="basis-full md:basis-1/3">
                <h1 className="text-center sm:text-2xl my-3">Nestify</h1>
                <p className="m-4">Connecting homeowners with trusted service providers for all household needs.</p>
            ...
            <div className="basis-full md:basis-1/3 ml-20">
            <h1 className="my-3">Quick links</h1>
            <ul className="">
            ...
            <div className="my-2">
                ...
                <div className="flex space-x-2 my-3">
                    ...
                    <h2>hello@servicehub.com</h2>
                </div>
                <div className="flex space-x-2 my-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-map-pin-icon lucide-map-pin"><path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0"/><circle cx="12" cy="10" r="3"/></svg>
                    <h2>123 Service St, City, State 12345</h2>
                </div>
            </div>
            </div>
        </div>
