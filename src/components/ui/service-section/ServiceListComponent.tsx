...
export default function ServiceComponent(){
    ...
    return(
        ...
        <div className="my-5">
            ...
            <h1 className="text-4xl lg:text-5xl text-center text-[#0A192F] font-display font-bold">Popular Services</h1>
            <p className="text-lg lg:text-xl text-center text-[#475569]">Browse our most requested household services and find the perfect professional for your needs.</p>
