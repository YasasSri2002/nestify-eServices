            ...
            <div className="sm:grid sm:grid-cols-2">
                <div className="col-1">
                    <div className="grid justify-items-center content-center p-10 gap-4">
                        <div className="flex">
                            <div className="rounded-full w-2.5 h-2.5 bg-accent-600 flex justify-center items-center 
                                mb-5 p-5">
                        ...
                        <div className="flex">
                            <div className="rounded-full w-2.5 h-2.5 bg-accent-600 flex justify-center items-center mb-5 p-5">
