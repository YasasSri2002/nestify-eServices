    ...
    return(
        ...
        <div>
            ...
            <div className="flex flex-wrap w-full gap-4">
                <div className="flex-1  bg-white m-2 rounded-3xl shadow-xl py-2">
                 ...
                 <div className="flex-1 bg-white m-2 rounded-3xl shadow-2xl py-2">
                    <div className="grid justify-items-center">
                    <div className="rounded-full w-[75px] h-[75px] bg-white/80 flex justify-center items-center mb-5 shadow-2xl hover:border-1 hover:border-black/80">
                        <DynamicIcon name="FaUserCheck" className="text-3xl" />
                    </div>
                    <h1 className="font-bold text-black/80">Compare & Choose</h1>
                    <p className="text-gray-800/80 text-center">Review profiles, ratings, and quotes to find the perfect match.</p>
                </div>
                </div>
                 <div className="flex-1 bg-white m-2 rounded-3xl shadow-2xl py-2">
                    <div className="grid justify-items-center">
                    ...
                    <p className="text-gray-800/80 text-center">Schedule your service at a time that works for you.</p>
                </div>
                </div>
                 <div className="flex-1 bg-white m-2 rounded-3xl shadow-2xl py-2">
                    <div className="grid justify-items-center">
                    ...
                    <p className="text-gray-800/80 text-center">Enjoy professional service and leave a review when complete.</p>
                </div>
                </div>
